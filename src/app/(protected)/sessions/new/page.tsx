...
export default async function NewSessionPage({ searchParams }: { searchParams: Promise<{ courseId?: string; materialId?: string }> }) {
  ...
  const initial = { courseId: query.courseId, ...material?.analysis?.suggestedSession, sourceName: material?.name, rules: material?.analysis?.collaboration.summary };
  return (
    <>
